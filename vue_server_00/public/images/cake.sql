...
CREATE TABLE Directory(
    ...
    price DECIMAL(7,2) NOT NULL,#蛋糕价格
    cpic VARCHAR(128),#图片
    clsid INT#蛋糕类型
);
...
/*用户登录*/
INSERT INTO cake_login VALUES(NULL,'khy',123456);
INSERT INTO cake_login VALUES(NULL,'xp',123456);
INSERT INTO cake_login VALUES(NULL,'zwb',123456);
INSERT INTO cake_login VALUES(NULL,'xyb',123456);

/**用户信息**/
INSERT INTO cake_user VALUES(NULL,'khy',123456,'khy@qq.com','13666668888');
INSERT INTO cake_user VALUES(NULL,'xp',123456,'xp@qq.com','13688886666');
INSERT INTO cake_user VALUES(NULL,'zwb',123456,'zwb@qq.com','13686866868');
INSERT INTO cake_user VALUES(NULL,'xyb',123456,'xyb@qq.com','13699996666');
...
INSERT INTO Directory VALUES (null,"圣诞礼盒系列","在「花盒」赏心悦目的同时，仔细品尝美食，回味玫瑰香气。 特别提示：花盒中所含鲜花仅为装饰，不可食用。","「百利甜情人」+「圣诞礼盒」","298.00","55.jpg",8);
